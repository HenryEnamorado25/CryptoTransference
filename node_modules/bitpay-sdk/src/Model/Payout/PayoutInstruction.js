...
var PayoutCreationException_1 = require("../../Exceptions/PayoutCreationException");
var PayoutInstruction = /** @class */ (function () {
    /**
     ...
     */
    function PayoutInstruction(amount, method, methodValue) {
        this.amount = amount;
        switch (method) {
