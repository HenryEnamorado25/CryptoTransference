...
var Rates = /** @class */ (function () {
    function Rates(rates, client) {
        this._rates = this.castRatesObj(rates);
        this._client = client;
    }
    Rates.prototype.castRatesObj = function (ratesObj) {
        try {
    ...
    Rates.prototype.GetRates = function () {
        return this._rates;
    };
    Rates.prototype.Update = function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = this;
                        return [4 /*yield*/, Promise.resolve(this._client.GetRates())];
                    case 1:
                        _a._rates = _b.sent();
                        return [3 /*break*/, 3];
                    case 2:
                        e_1 = _b.sent();
                        throw new RateQueryException_1.default(e_1);
                    case 3: return [2 /*return*/];
                }
            });
        });
    };
    Rates.prototype.GetRate = function (currencyCode) {
        var val = 0;
